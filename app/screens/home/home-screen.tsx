...
import { View, ViewStyle, TextStyle, Modal, Dimensions } from "react-native"
...
import { Record, useStores } from "../../models"
...
export const HomeScreen: FC<StackScreenProps<NavigatorParamList, "home">> = observer(() => {
  ...
  const [records, setRecords] = React.useState<Array<Record>>(rootStore.recordStore.listRecords())

  React.useEffect(() => {
    setRecords(rootStore.recordStore.listRecords())
  }, [isFocused])
